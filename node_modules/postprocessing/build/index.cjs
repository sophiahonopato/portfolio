...
var EffectComposer = class {
  ...
  constructor(renderer = null, {
    ...
    stencilBuffer = false,
    multisampling = 0,
    frameBufferType = import_three5.UnsignedByteType
  } = {}) {
    this.renderer = null;
  ...
  createDepthTexture() {
    ...
    const outputDepthTexture = new import_three5.DepthTexture();
    ...
    const stableDepthTexture = new import_three5.DepthTexture();
